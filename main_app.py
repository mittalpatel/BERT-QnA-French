# ==============================================================================
# title              : main_app.py
# description        : This is the flask app for BERT QNA FRENCH DEMO which receives the request and provide response.
...
# json_json() function is used to convert the input data i.e paragraph and question into the SQUAD like format, then we will be storing this data in a file named input_french.json which is used as prediction file in run_squad command that you will see further in submitted_form() function.
...
def submitted_form():
    ...
    if request.method == 'POST':
        ...
        with open('input_french.json', 'w') as f:
  ...
  --predict_file=input_french.json \
  --init_checkpoint=bert/model/french_model.ckpt-13615 \
  --do_lower_case=False \
  --max_seq_length=192 \
  --doc_stride=128 \
  --do_train=False \
